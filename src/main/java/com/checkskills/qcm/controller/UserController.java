...
public class UserController {
    ...
    void sendEmail(String email, String token) throws MessagingException, IOException {
        ...
        helper.setText("<h3>Veuillez redéfinir un mot de passe en suivant ce lien :</h3></br><a href='https://jungle-skills-front.herokuapp.com/reset-password/"+token+"'> https://jungle-skills-front.herokuapp.com/reset-password/</a>", true);
